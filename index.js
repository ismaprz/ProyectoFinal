...
const conexion = mysql.createConnection({
    ...
    password: process.env.PASSWORD || "Ata1mayo91",
    database: process.env.DATABASE || "DataClins",
...
app.post('/formClientes', (req, res) => {
 ...
 app.post('/delete', (req, res)=>{
   let sql = "DELETE FROM turnos where idFormClientes= " + req.body.idFormClientes +  "" ; conexion.query(sql,function(err, result){ if(err) throw err;
...
app.post('/delete', (req, res)=>{
    let sql = "DELETE FROM turnos where idTurnos= " + req.body.idTurnos +  "" ; conexion.query(sql,function(err, result){ if(err) throw err;
     console.log('Dato eliminado : ' + result.affectedRows);
     res.render('turnos')
    })
